...
| 7 | H6: classical spacetime from decohered pulse histories | Accepted with limits for reduced branch-decoherence bookkeeping and model comparison; H6S1 adds an executable weak-field quantum source-response diagnostic tool; H6S2 adds an ensemble-decomposition-invariance admissibility filter with a clean no-go subtheorem; H6S3 adds the no-free-branch-variance theorem and route ledger; full classical-spacetime emergence and a real source-response law remain blocked | `appendix/h6/decohered_pulse_histories_classical_spacetime.md`, `appendix/h6/quantum_source_response_discriminator.md`, `appendix/h6/causal_pulse_response_kernel.md`, `appendix/h6/no_free_branch_variance.md`, `src/pulse_model/calculations.py`, `src/pulse_model/quantum_source_response.py`, `src/pulse_model/causal_pulse_response.py`, `src/pulse_model/no_free_branch_variance.py`, `tests/test_h6_branch_decoherence.py`, `tests/test_quantum_source_response.py`, `tests/test_causal_pulse_response.py`, `tests/test_no_free_branch_variance.py` | Use H6 only as a bounded branch-distinguishability, source-to-metric comparison, and source-response diagnostic framework; H6S3 means branch pulse-count variance is not physical merely from ensemble notation. Later work must choose a density-only, record-conditioned, stochastic classical, or non-classical geometry/mediator route before treating branch variance as physical. Stronger emergence still needs energy/no-signaling accounting, branch-selection dynamics, a causal source-response law, and macroscopic GR recovery. |
