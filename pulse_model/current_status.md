...
The main evidence is in [Evidence](./evidence/index.md), especially the [known-physics validation report](./evidence/known_physics_validation.md), and the formal derivations in [the formal model](./formal_model/index.md).
...
- a physical source-response law for how geometry responds to quantum pulse-history branches
