...
| 7 | H6: classical spacetime from decohered pulse histories | Accepted with limits for reduced branch-decoherence bookkeeping and model comparison; H6S1 adds an executable weak-field quantum source-response diagnostic tool; H6S2 adds an ensemble-decomposition-invariance admissibility filter with a clean no-go subtheorem; H6S3 adds the no-free-branch-variance theorem and route ledger; H6S4-C adds a finite stochastic pulse-potential diagnostic with final verdict diagnostic tool; H6S4-Q adds a finite quantum mediator conditional derivation; full classical-spacetime emergence and a real source-response law remain blocked | `appendix/h6/decohered_pulse_histories_classical_spacetime.md`, `appendix/h6/quantum_source_response_discriminator.md`, `appendix/h6/causal_pulse_response_kernel.md`, `appendix/h6/no_free_branch_variance.md`, `appendix/h6/minimal_stochastic_pulse_geometry.md`, `appendix/h6/minimal_quantum_pulse_geometry.md`, `src/pulse_model/calculations.py`, `src/pulse_model/quantum_source_response.py`, `src/pulse_model/causal_pulse_response.py`, `src/pulse_model/no_free_branch_variance.py`, `src/pulse_model/stochastic_pulse_geometry.py`, `src/pulse_model/quantum_pulse_geometry.py`, `tests/test_h6_branch_decoherence.py`, `tests/test_quantum_source_response.py`, `tests/test_causal_pulse_response.py`, `tests/test_no_free_branch_variance.py`, `tests/test_stochastic_pulse_geometry.py`, `tests/test_quantum_pulse_geometry.py` | Use H6 only as a bounded branch-distinguishability, source-to-metric comparison, and source-response diagnostic framework; H6S3 means branch pulse-count variance is not physical merely from ensemble notation. H6S4-C may be used as a finite stochastic variance comparator, not as an accepted stochastic classical law. H6S4-Q may be used as a finite quantum mediator comparator and conditional derivation, not as an accepted Pulse Model quantum geometry law. Stronger emergence still needs energy/no-signaling accounting, branch-selection dynamics, a general conserved source-response law, and macroscopic GR recovery. |
...
3. Use H6, H6S1, H6S2, and H6S3 downstream only as bounded branch-distinguishability, source-to-metric comparison, no-free-branch-variance, and source-response diagnostic frameworks; do not treat the reduced toy models, ensemble-invariance guardrail, or route ledger as a full emergence proof or a real source-response law.
