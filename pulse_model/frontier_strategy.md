...
This path would try to prove that a corrected loop record contains a phase increment $\delta\Theta_L$ with three properties:
...
- a predicted equation of state $w(a)$ or equivalent observable law
