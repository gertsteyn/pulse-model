...
The follow-up appendix `geometry_action_strengthening_pulse_network.md` upgrades this result to a stronger conditional derivation. It defines admissible pulse networks, maps H3 frame holonomies to non-null Lorentzian hinge defects, states locality, scalarization, and refinement-invariance sufficient conditions, adds a small pulse-Regge prototype, and classifies corrections and alternatives.
