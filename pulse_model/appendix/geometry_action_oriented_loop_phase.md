...
The Markdown math guardrail scan also checks the 05S4 appendix, `proof_sequence.md`, and `promising_tweaks.md` for forbidden math delimiters, equation environments, labels, tags, and text macros.
