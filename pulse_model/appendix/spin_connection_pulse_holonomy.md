...
**Canonical source:** [05S5 Spin And Full Connection Holonomy Frontier](./geometry_action/spin_connection_holonomy.md)
...
The canonical 05S5 appendix is `pulse_model/appendix/geometry_action/spin_connection_holonomy.md`. It contains the spin/full-connection record contract, tetrad and spin-connection conventions, standard spinor recovery, H3 representation-lift theorem, bounded connection residual diagnostic, benchmarks, adversarial review, and final verdict.
...
|---|---|---|
| `pulse_model/appendix/spin_connection_pulse_holonomy.md` | this file | `pulse_model/appendix/geometry_action/spin_connection_holonomy.md` |
