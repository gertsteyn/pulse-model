---
title: 05S Geometry Action Strengthening From Pulse Networks
sidebar_label: 05S Pulse Network
sidebar_position: 3
---
...
The closed 05 appendix, `phase_functional_from_pulse_consistency.md`, accepted the Einstein-Hilbert plus cosmological-constant phase only as a conservative low-energy result with explicit limits. It did not prove that raw pulse data force locality, scalarization to $R$, refinement invariance, suppression of higher-curvature corrections, or full Lorentzian Regge boundary behavior.
