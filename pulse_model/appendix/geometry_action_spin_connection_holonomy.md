...
|---|---|---|
| `pulse_model/appendix/spin_connection_pulse_holonomy.md` | `pulse_model/appendix/spin_connection_pulse_holonomy.md` | `pulse_model/appendix/geometry_action_spin_connection_holonomy.md` |
...
Markdown math scan for touched docs: run the project forbidden-delimiter scan against this appendix, `proof_sequence.md`, and `promising_tweaks.md`.
...
The refreshed roadmap files already match this boundary: `proof_sequence.md` keeps 05S5 as a diagnostic layer without accepted source-response, and `promising_tweaks.md` recommends a quantum source-response law successor using H6S1 gates rather than treating H6S1 as the law itself.
