---
title: H6 Decohered Pulse Histories And Classical Spacetime
sidebar_label: Decohered Histories
sidebar_position: 2
---
...
[The 05 geometry-action result](../geometry_action/phase_functional_from_pulse_consistency.md) is accepted with limits as a useful conservative result. H6 may use it only as a smooth, low-energy, branch-local classical source-to-metric rule under the 05 assumptions:
