---
title: H2 Raw Event-Graph Reconstruction
sidebar_label: Raw Event Graph
sidebar_position: 6
---
...
- `pulse_model/appendix/h2/raw_event_graph_reconstruction.md`
- `pulse_model/src/pulse_model/raw_record_reconstruction.py`
- `pulse_model/tests/test_raw_record_reconstruction.py`

Roadmap files such as `pulse_model/roadmap.md` and `pulse_model/frontier_strategy.md` are not part of the early H2S1 tasks. They are reserved for the final verdict task after its Beads blocker is closed.
